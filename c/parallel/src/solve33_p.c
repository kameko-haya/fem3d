...
**/
	if( ICFLAG == 0 ){
		...
		if (PRECOND == 0) {
            if (iterPREmax == 1) strcat(BUF.name,"BILU(0)-no ASDD");
            if (iterPREmax == 2) strcat(BUF.name,"BILU(0)-1x ASDD");
            if (iterPREmax == 3) strcat(BUF.name,"BILU(0)-2x ASDD");
            if (iterPREmax == 4) strcat(BUF.name,"BILU(0)-3x ASDD"); 
		}
